    ...
    var body: some View {
        Form {
            Section(header: Text("Basic settings")) {
                TextField("ProjectName", text: $title.onChange(update))
                TextField("Description of this project", text: $detail.onChange(update))

            }
            
            Section(header: Text("ustom Project Color")) {
            ...
            Section(footer: Text("Closing a project moves it from the Open to Closed tab; deledting it removes the project entirely.")) {
